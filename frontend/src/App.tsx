...
import { HackathonPipelinePage } from "./pages/HackathonPipelinePage";
...
function Shell() {
  ...
  const commands = useMemo(
    () => [
      ...
      { id: "pipeline", label: "Open Hackathon Pipeline", run: () => navigate("/pipeline") },
      {
        id: "export",
  ...
  return (
    <Routes>
      <Route element={<Shell />}>
        ...
        <Route path="/pipeline" element={<HackathonPipelinePage />} />
      </Route>
    </Routes>
  );
}
