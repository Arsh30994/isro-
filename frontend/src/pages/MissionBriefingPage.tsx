...
const TOPICS: BriefingTopic[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Hackathon pipeline site", to: "/pipeline" },
      { label: "Register", to: "/register" },
    ],
  },
  {
    id: "combined-pipeline",
    kicker: "06 · Combined repo",
    title: "ISRO pipeline site + LunaMatch",
    summary:
      "This repository merges the original static ISRO DFSAR briefing site with the full LunaMatch registration and mission-planning stack.",
    details: [
      "The Hackathon Pipeline page embeds the original single-file site: live CPR/DOP classifier, terrain slope map, rover path metrics, ice-volume scenarios, module code tabs, judging rubric, and a persistent pre-submission checklist.",
      "LunaMatch adds image registration (CLAHE → correspondence → RANSAC), the staged LUNA/ICE planner, Solar & Illumination labs, and optional platform APIs.",
      "Shared science concept: IceCandidate ≈ (CPR > 1.0) ∧ (DOP < 0.13), with honesty labels — illustrative / planning support, not confirmed ice or certified landing.",
    ],
    links: [
      { label: "Open Hackathon Pipeline", to: "/pipeline" },
      { label: "Open LUNA/ICE", to: "/ice" },
    ],
  },
];
