...
import { Aperture, Orbit, Snowflake, BookOpen, Radar } from "lucide-react";
...
const CARDS = [
  ...
  },
  {
    ...
    desc: "ISRO DFSAR briefing site — live CPR/DOP classifier, terrain, volume, checklist",
  },
  {
    to: "/solar",
    icon: Orbit,
      ...
      <div className="space-y-6">
        ...
        >
          <GlassCard className="!p-6">
            <p className="kicker">Landing · Smart India Hackathon · PS 26166 · Combined ISRO pipeline</p>
            ...
            <p className="mt-3 max-w-xl text-[var(--muted)] leading-7">
              Sun-angle–robust lunar image registration and polar mission planning for SIH PS 26166 —
              merged with this repo’s ISRO Chandrayaan-2 DFSAR ice-detection pipeline briefing.
            </p>
            <div className="mt-5 flex flex-wrap gap-3">
              <button type="button" className="btn btn-primary" onClick={() => navigate("/register")}>
                Start registration
              </button>
              <button type="button" className="btn btn-secondary" onClick={() => navigate("/pipeline")}>
                Hackathon pipeline
              </button>
